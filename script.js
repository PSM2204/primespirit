...
(function () {
  ...
  css.textContent = [
    /* FAQ */
    '.faq-answer{max-height:0;overflow:hidden;transition:max-height .35s ease,padding .35s ease;padding:0 20px;opacity:0}',
    '.faq-answer.faq-answer-open{max-height:500px;padding:16px 20px;opacity:1}',
    '.faq-question{width:100%;display:flex;justify-content:space-between;align-items:center;background:none;border:1px solid rgba(255,255,255,.08);color:var(--text,#e8ecf4);padding:18px 22px;border-radius:12px;cursor:pointer;font-size:1rem;font-weight:600;text-align:left;transition:border-color .2s,background .2s}',
    '.faq-question:hover{border-color:rgba(0,198,255,.3);background:rgba(0,198,255,.04)}',
    '.faq-question[aria-expanded="true"]{border-color:rgba(0,198,255,.4);background:rgba(0,198,255,.06)}',
    '.faq-question[aria-expanded="true"] .fa-chevron-down{transform:rotate(180deg)}',
    '.faq-question .fa-chevron-down{transition:transform .3s ease;font-size:.85rem;color:rgba(255,255,255,.4);margin-left:16px;flex-shrink:0}',
    '.faq-item{margin-bottom:12px}',

    /* Auth modal */
    '.auth-modal-overlay{position:fixed;inset:0;background:rgba(0,0,0,.7);backdrop-filter:blur(8px);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px}',
    '.auth-modal-overlay[hidden]{display:none!important}',
    '.auth-modal-card{background:var(--surface,#111633);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:40px;max-width:440px;width:100%;position:relative;max-height:90vh;overflow-y:auto}',
    '.close-modal-btn{position:absolute;top:16px;right:16px;background:none;border:none;color:var(--text-sec,#8b95ad);font-size:1.3rem;cursor:pointer;padding:8px;border-radius:8px;transition:color .2s,background .2s}',
    '.close-modal-btn:hover{color:var(--text,#e8ecf4);background:rgba(255,255,255,.06)}',
    '.auth-view-panel h3{font-family:var(--font-head);font-size:1.5rem;margin-bottom:8px}',
    '.auth-sub{color:var(--text-sec,#8b95ad);font-size:.9rem;margin-bottom:24px;line-height:1.6}',
    '.auth-options-row{display:flex;justify-content:flex-end;margin-bottom:16px}',
    '.text-link-btn{background:none;border:none;color:var(--accent,#00C6FF);font-size:.85rem;cursor:pointer;padding:4px;text-decoration:underline;transition:opacity .2s}',
    '.text-link-btn:hover{opacity:.8}',
    '.auth-switch-prompt{text-align:center;margin-top:20px;color:var(--text-sec,#8b95ad);font-size:.9rem}',
    '.pass-strength-meter{height:4px;background:rgba(255,255,255,.08);border-radius:3px;margin-top:8px;overflow:hidden}',
    ...
    /* Quiz */
    '.quiz-btn-selected{border-color:var(--accent,#00C6FF)!important;background:rgba(0,198,255,.12)!important;box-shadow:0 0 24px rgba(0,198,255,.18);transform:scale(1.02)}',
    '.quiz-profile-header{text-align:center;margin-bottom:28px}',
    '.quiz-profile-name{font-family:var(--font-head);font-size:1.6rem;font-weight:800;color:var(--accent,#00C6FF);display:block}',
    '.quiz-profile-tagline{color:var(--text-sec,#8b95ad);font-size:.95rem;margin-top:6px;font-style:italic}',
    ...
    '.quiz-metric-label{flex:0 0 140px;font-family:var(--font-mono);font-size:.75rem;color:var(--text-sec,#8b95ad);text-transform:uppercase;letter-spacing:.06em}',
    ...
    '.quiz-metric-value{flex:0 0 42px;text-align:right;font-family:var(--font-mono);font-size:.85rem;font-weight:600;color:var(--text,#e8ecf4)}',
    '.quiz-insight-box{background:var(--surface,#111633);border:1px solid rgba(255,255,255,.1);border-radius:14px;padding:22px;margin-bottom:18px;opacity:0;transform:translateY(16px);transition:opacity .5s ease,transform .5s ease}',
    '.quiz-insight-box.visible{opacity:1;transform:translateY(0)}',
    '.quiz-insight-label{font-family:var(--font-mono);font-size:.68rem;text-transform:uppercase;letter-spacing:.12em;color:var(--accent,#00C6FF);margin-bottom:6px}',
    '.quiz-insight-title{font-family:var(--font-head);font-size:1.1rem;font-weight:700;margin-bottom:8px;color:var(--text,#e8ecf4)}',
    ...
    '.form-group input,.form-group select,.form-group textarea{width:100%;padding:12px 16px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:10px;color:var(--text,#e8ecf4);font-family:inherit;font-size:.95rem;transition:border-color .2s,box-shadow .2s}',
    '.form-group input:focus,.form-group select:focus,.form-group textarea:focus{outline:none;border-color:var(--accent,#00C6FF);box-shadow:0 0 0 3px rgba(0,198,255,.15)}',
    '.btn{display:inline-flex;align-items:center;gap:8px;padding:14px 28px;border-radius:12px;font-weight:700;font-size:.95rem;border:none;cursor:pointer;transition:all .2s ease;text-decoration:none}',
    '.btn-primary{background:linear-gradient(135deg,var(--accent,#00C6FF),var(--blue,#0070F3));color:#fff;box-shadow:0 4px 20px rgba(0,198,255,.25)}',
    ...
    '.quiz-btn{display:block;width:100%;text-align:left;padding:16px 22px;margin-bottom:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);border-radius:12px;color:var(--text,#e8ecf4);font-size:.95rem;cursor:pointer;transition:all .2s;font-family:inherit;line-height:1.5}',
    '.quiz-btn:hover{border-color:rgba(0,198,255,.3);background:rgba(0,198,255,.05)}',

    /* Toast */
    '.ps-toast{position:fixed;bottom:30px;left:50%;transform:translateX(-50%) translateY(80px);background:var(--surface,#111633);border:1px solid rgba(0,198,255,.3);color:var(--text,#e8ecf4);padding:16px 28px;border-radius:14px;z-index:10001;font-size:.95rem;opacity:0;transition:all .4s cubic-bezier(.22,1,.36,1);pointer-events:none;max-width:90vw;text-align:center;box-shadow:0 8px 40px rgba(0,0,0,.4)}',
    '.ps-toast.show{opacity:1;transform:translateX(-50%) translateY(0);pointer-events:auto}',

    '@media(max-width:600px){.quiz-metric-label{flex:0 0 90px;font-size:.65rem}.quiz-metric-value{font-size:.78rem}.auth-modal-card{padding:28px 20px}}'
  ].join('\n');
